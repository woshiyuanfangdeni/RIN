    ...
    void Move()
    {
        if(direction == 1||direction == 2)
        {
            if(transform.position.x < maxX)//自身位置在左边就往右走
            {
                ...
                Vector2 nowPos = new Vector2(transform.position.x + moveAmountX, transform.position.y);
        ...
        }else if(direction == 5)
        {
            ...
            if(transform.position.y> minY)//自身位置在上边才能往下走
            {
                ...
                Vector2 nowPos = new Vector2(transform.position.x, transform.position.y - moveAmountY);
                transform.position = nowPos;
